...
class Canada(MarketHolidayBase):
    # https://www.thecse.com/en/trading/market-operations (Canadian Securities Exchange)
    ...
    def _populate(self, year):
        ...
        if year >= 1931:
            if year == 1935:
                ...
                self[date(1935, 10, 25)] = "US Thanksgiving Day"
            else:
                self[date(year, OCT, 1) + rd(weekday=MO(+2))] = "US Thanksgiving Day"
