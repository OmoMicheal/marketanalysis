...
class MarketHolidayBase(dict):
    ...
    def __add__(self, other):
        if isinstance(other, int) and other == 0:
            ...
            return self
        elif not isinstance(other, MarketHolidayBase):
            raise TypeError()
    ...
    def __reduce__(self):
        return super(MarketHolidayBase, self).__reduce__()


def createHolidaySum(h1, h2):
    class HolidaySum(MarketHolidayBase):
