...
# from MarketTradingDaysBase import __keytransform__
        
class Canada(MarketTradingDaysBase):
    ...
    def future_list(self, current_date, lookup_step): 
        ...
        def allDays(current_date, future_date):
            nextDay = []
            marketholidays_US = marketholidays.CA()
...
# print(a.prevDays(current_date, lookback_step))
# ####################################################